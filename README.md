...
⚡ Designed to reliably handle background jobs using an **event-driven, fault-tolerant architecture**  
...
2. Scheduler polls DB every 5 seconds  
3. Applies **locking + priority sorting**  
4. Marks job as **RUNNING**  
5. Publishes job to Kafka  
6. Worker consumes job  
7. Executes asynchronously  
8. ✅ On success → **SUCCESS**  
9. ❌ On failure → Retry (backoff) → DLQ  
